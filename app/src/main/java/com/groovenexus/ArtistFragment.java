...
public class ArtistFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.activity_artists, container, false);

        RecyclerView recyclerView = v.findViewById(R.id.recyclerViewArtist);
        ...
        v.findViewById(R.id.artistText).setOnClickListener(new View.OnClickListener() {
            @Override
